...
- Templates for popular classification algorithms:
   - # Linear classification &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; [<img src="images/linear_classification.png" alt="Alt Text" width="5%">](Linear_classification.py) <sup><sub><sup>[<span style="font-size: smaller;">click me</span>](Linear_classification.py)</sup></sub></sup>
    - # Multiple classification  &nbsp; [<img src="images/graph.png" alt="Alt Text" width="5%">](Multiple_classification.py) <sup><sub><sup>[<span style="font-size: smaller;">click me</span>](Multiple_classification.py)</sup></sub></sup>
    - # Polynomial classification &nbsp; [<img src="images/graphj_report.png" alt="Alt Text" width="6.5%">](Polynomial_classification.py) <sup><sub><sup>[<span style="font-size: smaller;">click me</span>](Polynomial_classification.py)</sup></sub></sup>
    - # Support vector classification (SVR)  &nbsp; [<img src="images/brain_book.png" alt="Alt Text" width="5%">](Support_vector_classification.py) <sup><sub><sup>[<span style="font-size: smaller;">click me</span>](Support_vector_classification.py)</sup></sub></sup>
    - # Decision tree [<img src="images/decision1.png" alt="Alt Text" width="6%">](Decision_tree_classification.py) <sup><sub><sup>[<span style="font-size: smaller;">click me</span>](Decision_tree_classification.py)</sup></sub></sup>
